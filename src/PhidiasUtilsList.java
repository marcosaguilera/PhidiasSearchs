...
public class PhidiasUtilsList {
    
    public List phidiasResponse(int codigo){
        System.out.println(codigo);
            ...
            try{
                ...
                while (rs.next()){
                    ...
                    list.add(obj);
                    System.out.println("el objeto JSON\n");
                    System.out.println(obj);
                    System.out.println("el List \n");
    ...
    public static void main(String[]arg){
        PhidiasUtilsList phidiasUtilsList = new PhidiasUtilsList();
        phidiasUtilsList.phidiasResponse(15031);
    }  
